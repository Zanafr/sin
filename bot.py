...
bot = Robot_Rubika("nnskeysqufomuumkcgcnpkvlqjhjxxvt")

your_Group_Link="https://rubika.ir/joing/DCEIHHBE0TFQWVWCVPLBEYOAWXDBQHPO"
...
bot.sendMessage(Group_Guid,"""سین زن zana__4u با موفقیت فعال شد🌚
...
𝙿𝚛𝚘𝚐𝚛𝚊𝚖𝚖𝚎𝚛 : @zanafr__x""",message_id=msg.get("message_id"))
							except:pass
